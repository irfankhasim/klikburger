...
export function costPerUnit(ing) {
  var fifo = ing && typeof ing.effectiveCostPerUnit === "number" ? ing.effectiveCostPerUnit : NaN;
  if (!isNaN(fifo) && fifo > 0) return fifo;
  if (!ing || !ing.purchaseQty || ing.purchaseQty <= 0) return 0;
